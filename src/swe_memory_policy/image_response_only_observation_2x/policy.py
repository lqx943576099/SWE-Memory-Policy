...
CONDITION_NAME = "image_response_only_observation_2x"
LINEAR_DOWNSCALE_FACTOR = 2


def render_responses_image_response_only_observation_2x(
...
def build_responses_observation_image_block_2x(
    *,
    sequence_index: int,
    oa_index: int,
    tool_index: int,
